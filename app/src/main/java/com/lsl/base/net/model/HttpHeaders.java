...
public class HttpHeaders implements Serializable {
    ...
    /**
     * 也可以在Application中创建一个WebView，然后拿到这个userAgent
     * @return
     */
    public static String getUserAgent(){
        if (TextUtils.isEmpty(userAgent)){
            ...
            try {
                ...
                Integer resId = webUserAgentField.getInt(null);
                webUserAgent = OkHttp.getContext().getString(resId);
    ...
    public static String formatMillisToGMT(long milliseconds){
        ...
        SimpleDateFormat format = new SimpleDateFormat(FORMAT_HTTP_DATA , Locale.US);
    ...
    public String toString() {
        return "OkHttp{ "+ "headersMap = " + headersMap + " }";
    }
}
