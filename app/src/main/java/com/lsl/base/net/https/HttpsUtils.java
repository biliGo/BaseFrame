package com.lsl.base.net.https;
...
public class HttpsUtils {
    ...
    private static KeyManager[] prepareKeyManager(InputStream bskFile,String password){
        try{
            if (bskFile == null || password ==null ) return null;
            KeyStore clientKeyStore = KeyStore.getInstance("BKS");
            clientKeyStore.load(bskFile,password.toCharArray());
